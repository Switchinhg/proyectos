...
import swai from '/wave.svg'
export default function Footer() {
  return (
      <footer className="footer">
        {/* <svg className="position"preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#0F2027" fillOpacity="1" d="M0,192L26.7,186.7C53.3,181,107,171,160,186.7C213.3,203,267,245,320,261.3C373.3,277,427,267,480,245.3C533.3,224,587,192,640,186.7C693.3,181,747,203,800,213.3C853.3,224,907,224,960,213.3C1013.3,203,1067,181,1120,154.7C1173.3,128,1227,96,1280,80C1333.3,64,1387,64,1413,64L1440,64L1440,0L1413.3,0C1386.7,0,1333,0,1280,0C1226.7,0,1173,0,1120,0C1066.7,0,1013,0,960,0C906.7,0,853,0,800,0C746.7,0,693,0,640,0C586.7,0,533,0,480,0C426.7,0,373,0,320,0C266.7,0,213,0,160,0C106.7,0,53,0,27,0L0,0Z"></path></svg> */}
        <img className="position" src={swai} alt="Wave for looks" />
